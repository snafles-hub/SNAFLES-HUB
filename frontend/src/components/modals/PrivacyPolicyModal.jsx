          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-blue-100">Your privacy matters to us</p>
              </div>
            </div>
            <button
              onClick={onClose}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <span className="text-gray-700">Process your orders and payments</span>
                    </div>
                    <div className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                    ...
                    <div className="flex items-start space-x-3">
                      <span className="w-2 h-2 bg-indigo-600 rounded-full mt-2"></span>
                      <span className="text-gray-700">Send order updates and confirmations</span>
                    </div>
                  </div>
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      <span className="w-2 h-2 bg-gray-600 rounded-full"></span>
                      <span className="text-gray-700">Opt-out of marketing emails</span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <span className="w-2 h-2 bg-gray-600 rounded-full"></span>
